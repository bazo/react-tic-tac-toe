...
INSERT INTO "new_games" ("created_at", "creator_id", "creator_symbol", "current_player_id", "id", "name", "opponent_id", "size", "state", "to_win", "updated_at", "winnerId") SELECT "created_at", "creator_id", "creator_symbol", "current_player_id", "id", "name", "opponent_id", "size", "state", "to_win", "updated_at", "winnerId" FROM "games";
DROP TABLE "games";
